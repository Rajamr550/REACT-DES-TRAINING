...
describe("Test the Login Component", () => {
  ...
  test("email input field should accept email ", () => {
    ...
    expect(email.value).not.toMatch("dipesh");
    userEvent.type(email, "dippesh");
    expect(email.value).not.toMatch("dipesh.malvia@gmail.com");
    expect(email.value).toMatch("dippesh");
  ...
  test("should be able to submit the form", () => {
    ...
    const user = screen.getByText("email is dipesh@gmail.com");
